...
const api: ShellmateApi = {
  snapshot: () => call('snapshot'), chatContext: (id, draft) => call('chatContext', id, draft),
  ...
  createConversation: () => call('createConversation'), renameConversation: (id, title) => call('renameConversation', id, title), setTarget: (conversationId, connectionId, access) => call('setTarget', conversationId, connectionId, access),
