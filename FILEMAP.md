...
| `src/main/index.ts` | Electron lifecycle, secure storage, provider wiring, validated IPC, and app snapshots. |
...
| `src/main/chat-service.ts`, `src/main/assistant.ts` | Persistent streaming turns, per-target tools/approvals, prompt, cancellation, and context accounting. |
